...
### [v2.1.5] - Fix Group States for Stateless Controllers

-   Fix Group States for Stateless Controllers (Fixes #256) (#257)
    -   Battery Operated, ControlLinc and RemoteLinc (v1) devices are excluded from group states to correctly reflect the state since these devices don't update
        the controller status unless a button is pushed.
-   Bump pyupgrade from 2.31.0 to 2.31.1 (#250)
-   Bump pylint from 2.12.2 to 2.13.4 (#255)
-   Bump black from 22.1.0 to 22.3.0 (#253)
