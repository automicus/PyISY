...
INSTEON_TYPE_THERMOSTAT_TUP = tuple(INSTEON_TYPE_THERMOSTAT)
ZWAVE_CAT_THERMOSTAT = ["140"]

# Other special categories or types
INSTEON_TYPE_LOCK = ["15.", "4.64"]
INSTEON_TYPE_LOCK_TUP = tuple(INSTEON_TYPE_LOCK)
ZWAVE_CAT_LOCK = ["111"]

INSTEON_TYPE_DIMMABLE = ["1."]
INSTEON_TYPE_DIMMABLE_TUP = tuple(INSTEON_TYPE_DIMMABLE)
